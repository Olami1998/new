...
root=tk.Tk()
root.title('Olami Music player project')
...
playlist=Listbox(root,selectmode=MULTIPLE,bg="DodgerBlue2",fg="white",font=('arial',15),width=40)
playlist.grid(columnspan=5)

os.chdir(r'C:\Users\USER\Music\Foreign')
songs=os.listdir()
for s in songs:
